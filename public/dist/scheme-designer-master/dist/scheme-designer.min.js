...
(function (SchemeDesigner) {
    ...
    var Scheme = /** @class */ (function () {
        ...
        Scheme.prototype.drawFromCache = function () {
            ...
            this.view.drawBackground();
            if (this.cacheView && this.cacheView.getCanvas().width > 0 && this.cacheView.getCanvas().height > 0) {
                this.view.getContext().drawImage(this.cacheView.getCanvas(), 0, 0, t.right, t.bottom);
            }            
